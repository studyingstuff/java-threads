...
public class ApplicationWindow extends Application {
    ...
    RectangleThreadPool threadPool;
    @Override
    public void start(Stage stage) {
        this.createMainWindow(stage);
        this.threadPool = new RectangleThreadPool(4,200,Color.DARKGRAY);
    ...
    private void createTotalThread() {
        Thread calculateTotalSquaresThread = new Thread(() -> {
            ...
            while(isAtLeastOneThreadActive){
                try {
                    Platform.runLater(() -> Arrays.asList(WIN_RECTANGLES)
                            .stream()
                    ...
                    Thread.sleep(RectangleThread.THREAD_DELAY_NS );
